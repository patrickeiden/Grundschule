   ...
   <div class="col-sm-2"></div>
    <div id="firstheader">
     ...
     <div class="col-sm-3 text-left">        
       <img class="logo" src="../Images/grundschule.jpg" alt="Smiley face"  height="170" width="170">       
     </div>  
   </div> 
  		...
  		<div class="col">
              ...
              <li><a href="../userid26/frontpageUser26.php"><span class="glyphicon glyphicon-home"></span> Home</a></li><li><a  class="custome" href="../userid26/custome_id26.php"><span class="glyphicon glyphicon-star"></span>Lu</a></li><li class="dropdown">
                        <a href="javascript:void(0)"><span class="glyphicon glyphicon-picture"></span> Organisation</a>
                        <div class="dropdown-content"><a href="../userid26/impressum_id26.php"><span class="glyphicon glyphicon-road"></span> Impressum</a></div></li></ul>
            </nav>
          </div>
