     ...
     <div class="col-sm-3 text-left">        
       <img class="logo" src="../Images/Logo_grundschule.jpg" alt="Smiley face"  height="170" width="170">       
  		...
  		<div class="col">
              ...
              <li><a href="../userid25/frontpageUser25.php"><span class="glyphicon glyphicon-home"></span> Home</a></li><li><a  class="custome" href="../userid25/custome_id25.php"><span class="glyphicon glyphicon-star"></span>GanzTS</a></li><li class="dropdown">
                        <a href="javascript:void(0)"><span class="glyphicon glyphicon-picture"></span> Organisation</a>
                        <div class="dropdown-content"><a href="../userid25/impressum_id25.php"><span class="glyphicon glyphicon-road"></span> Impressum</a></div></li></ul>
            </nav>
          </div>
