     ...
     <div class="col-sm-3 text-left">        
       <img class="logo" src="Images//Logo_grundschule.jpg" alt="Smiley face"  height="170" width="170">       
          ...
          <div class="col-sm-3"></div>
              ...
              <li><a href="#"><span class="glyphicon glyphicon-home"></span>Home</a></li><li><a href="#"><span class="glyphicon glyphicon-star"></span>test</a></li></ul>
            </nav>
          </div>
        </div><div class="row">
          <div id="myCarousel" class="carousel slide" data-ride="carousel">       
            ...
            <div class="carousel-inner">         
              <div class="item active">
                  <img src="Images//Logo_grundschule.jpg">
                </div><div class="item">
                  <img src="Images//Logo_grundschule.jpg">
               </div>         
