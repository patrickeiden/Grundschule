   ...
   <div class="col-sm-2"></div>
    <div id="firstheader">
     <div class="Title col-sm-4">
    	<p class="name">Grundschule Losheim </p> 
     </div> 
     <div class="col-sm-3 text-left">        
       <img class="logo" src="/Logo_grundschule.jpg" alt="Smiley face"  height="170" width="170">       
     </div>  
   </div> 
          ...
          <div class="col-sm-3"></div>
              ...
              <li><a href="#"><span class="glyphicon glyphicon-home"></span>Home</a></li></ul>
            </nav>
          </div>
        </div><div class="row">
        ...
        <div class="row">       
          ...
          <div class="col-sm-6 text-center">           
            ...
            <p class="description">Das ist ein Test</p>
            <hr>
          </div>
        </div>
